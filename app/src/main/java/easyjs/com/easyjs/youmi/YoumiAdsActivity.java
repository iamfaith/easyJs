...
public class YoumiAdsActivity extends BaseActivity {
    ...
    private void setupSplashAd() {
        ...
        // 设置跳转的窗口类
        splashViewSettings.setTargetClass(EasyJsActivity.class);
        // 设置开屏的容器
        splashViewSettings.setSplashViewContainer(splashLayout);

        // 展示开屏广告
        SpotManager.getInstance(context)
                .showSplash(context, splashViewSettings, new SpotListener() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_youmi_ads);
